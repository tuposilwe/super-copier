...
makensis -DVERSION=0.3.1 -DEXE_PATH=../../target/x86_64-pc-windows-gnu/release/super-copier.exe packaging/windows/installer.nsi
...
cp packaging/linux/super-copier_0.3.1_amd64.deb Releases/Linux/SuperCopier-Linux.deb
